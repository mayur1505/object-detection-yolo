...
cap = cv2.VideoCapture('Demo Videos/cars.mp4')  # Use a video file
...
while True:
    ...
    imagGraphics = cv2.imread("Project 1 - Car Counter/graphics.png",cv2.IMREAD_UNCHANGED)
    img = cvzone.overlayPNG(img, imagGraphics, (0, 0))
