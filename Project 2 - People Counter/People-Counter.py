...
cap = cv2.VideoCapture('Demo Videos/people.mp4')  # Use a video file
...
while True:
    ...
    imagGraphics = cv2.imread("Project 2 - People Counter/graphics.png",cv2.IMREAD_UNCHANGED)
    img = cvzone.overlayPNG(img, imagGraphics, (730, 260))
